	...
	return (
		<>
			<div className="bg-brand-color">
				<div className="h-14 sm:h-11 container max-w-[1519px] md:px-40 mx-auto flex items-center justify-center sm:justify-between">
					<a href="#" className="text-lg text-white font-semibold md:bg-primary-brand-color md:px-4 md:mt-1 md:rounded-t-lg">
						<img className="w-15 h-15 md:w-10 md:h-10" data-testid="main-image"
